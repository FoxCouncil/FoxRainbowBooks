...
public readonly record struct CueSheetEntry
{
    ...
    /// <summary>Data form for CD-DA main data generated by the drive.
    /// Required for lead-in and lead-out entries: the host never streams
    /// either area, and drives (e.g. Pioneer BDR-XS07U fw 1.03) reject the
    /// whole cue sheet with 5/26/00 when they are marked host-supplied.</summary>
    public const byte DataFormGenerated = 0x01;
    ...
    /// <summary>
    /// Creates a lead-in entry at MSF 00:00:00. The drive generates the
    /// lead-in contents itself (<see cref="DataFormGenerated"/>).
    /// </summary>
    public static CueSheetEntry LeadIn() => LeadIn(DataFormGenerated);
    ...
    /// <summary>
    /// Creates a lead-out entry at the given MSF position. The drive
    /// generates the lead-out contents itself (<see cref="DataFormGenerated"/>).
    /// </summary>
